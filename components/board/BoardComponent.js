...
// 더미 데이터 (초기 게시글 목록)
const initialPosts = [
  { id: '1', user: '강지우', profileImage: require('../../assets/tino.png'), content: '최신 트렌드 공유해요!', likes: 5, comments: 2, isMine: false },
  { id: '2', user: '김민수', profileImage: require('../../assets/tino.png'), content: '트렌드 따라잡기!', likes: 3, comments: 1, isMine: false },
];
...
const styles = StyleSheet.create({
  ...
  notice: { textAlign: 'center', marginVertical: 10, fontSize: 32, fontWeight: 'bold', color: 'black' },
});
