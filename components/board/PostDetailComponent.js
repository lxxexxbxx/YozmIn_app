// PostDetailComponent.js (전체 파일 수정본)
                    ...
                    <View style={styles.modalOverlay}>
                        <TouchableWithoutFeedback>
                            <View style={styles.modalContent}>
                                ...
                                <TouchableOpacity style={styles.modalButton} onPress={() => deleteCommentRpc(selectedComment?.id, postId)}>
...
const styles = StyleSheet.create({
    ...
    // Modal styles (Instagram 느낌의 중앙 카드)
    modalOverlay: {
        flex: 1,
